...
- We sometimes need to move a guests from one unit to another.
- This may happen before the check-in, or during the stay.
- When the guest is relocated, we need to know what the orginal reservation was, as well as where the guest is actually staying for which days.
- We do not need to alter the price when a guest is relocated.
